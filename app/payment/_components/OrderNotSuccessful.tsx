...
const OrderNotSuccessful = ({ txnId }: { txnId: string }) => {
  return (
    <Container as="article" className="text-center max-w-xl min-h-[85vh] flex-col flex-center gap-y-4">
      ...
      <p>Make sure to share this <span className="text-black-one font-semibold">transaction ID</span> with us: <span className="font-bold text-primary-orange">{txnId}</span> </p>
